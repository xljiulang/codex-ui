...
// 模型快照卡片（设置 → 模型配置）：列出/新建/还原/删除/打开 CODEX_HOME/codex-ui/*.json。
// 还原成功后 emit("applied")，由父级重读一次模型配置（磁盘值即时同步）。
...
<template>
  <div class="model-config-card model-snapshot-card">
