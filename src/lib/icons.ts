...
/** 会话：加粗描边三点聊天气泡（发起/进行会话）；环形加粗 + 三点放大的底部小尾巴气泡，小尺寸更清晰 */
export const ICON_SESSION =
  "M12 2.2A8.3 8.3 0 1 1 15.1 18.2L12 22.8L8.9 18.2A8.3 8.3 0 1 1 12 2.2ZM12 4.1A6.4 6.4 0 1 1 14.39 16.44L12 19.98L9.61 16.44A6.4 6.4 0 1 1 12 4.1ZM7.4 9A1.4 1.4 0 1 0 7.4 11.8A1.4 1.4 0 1 0 7.4 9ZM12 9A1.4 1.4 0 1 0 12 11.8A1.4 1.4 0 1 0 12 9ZM16.6 9A1.4 1.4 0 1 0 16.6 11.8A1.4 1.4 0 1 0 16.6 9Z";
