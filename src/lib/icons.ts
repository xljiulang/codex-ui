...
/** 生成模型目录：圆圈+右箭头（Material arrow_circle_right：细圆环 + 实心箭头，单色填充） */
export const ICON_ARROW_CIRCLE_RIGHT =
  "M22,12c0-5.52-4.48-10-10-10C6.48,2,2,6.48,2,12s4.48,10,10,10C17.52,22,22,17.52,22,12z M4,12c0-4.42,3.58-8,8-8c4.42,0,8,3.58,8,8s-3.58,8-8,8C7.58,20,4,16.42,4,12z M16,12l-4,4l-1.41-1.41L12.17,13H8v-2h4.17l-1.59-1.59L12,8L16,12z";
