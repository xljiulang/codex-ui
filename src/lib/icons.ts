...
/** 会话：描边三点聊天气泡（发起/进行会话）；空心气泡 + 三点 + 底部小尾巴，减轻实心填充的视觉疲劳 */
export const ICON_SESSION =
  "M11.981 2.981c4.144 0 7.5 3.356 7.5 7.5 0 3.506-2.494 6.6-5.906 7.331l-0.656 0.131-0.337 0.581-0.581 0.994-0.562-0.994-0.337-0.581-0.656-0.131c-3.45-0.712-5.962-3.806-5.962-7.35 0-4.125 3.356-7.481 7.5-7.481m0-1.5c-4.969 0-9 4.031-9 9 0 4.331 3.075 7.969 7.163 8.813l1.875 3.244 1.875-3.244C17.944 18.413 20.981 14.813 20.981 10.5c0-4.988-4.031-9.019-9-9.019zM7.5 9c-0.825 0-1.5 0.675-1.5 1.5s0.675 1.5 1.5 1.5 1.5-0.675 1.5-1.5-0.675-1.5-1.5-1.5z m4.5 0c-0.825 0-1.5 0.675-1.5 1.5s0.675 1.5 1.5 1.5 1.5-0.675 1.5-1.5-0.675-1.5-1.5-1.5z m4.5 0c-0.825 0-1.5 0.675-1.5 1.5s0.675 1.5 1.5 1.5 1.5-0.675 1.5-1.5-0.675-1.5-1.5-1.5z";
